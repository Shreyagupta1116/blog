...
if ( ! function_exists( 'breadcrumb_trail' ) )
	get_template_part( 'inc/breadcrumbs.php' );
...
function breadcrumb_trail_setup() {
	...
	load_plugin_textdomain( 'chained', false, trailingslashit( dirname( plugin_basename( __FILE__ ) ) ) . 'lang' );
}
...
function breadcrumb_trail_theme_setup() {
	...
	if ( ! current_theme_supports( 'chained' ) )
